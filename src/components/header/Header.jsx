  ...
  return (
    <header className="header">
      ...
      <form action="#" className="search">
        ...
        />
        <NavLink to="/hotel" className="search__button">
          <svg
      ...
      <nav className="user-nav">
        <div className="user-nav__icon-box" onClick={props.handleOpenMessage}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
        ...
        {props.isOpenMessage ? (
          <Message handleCloseMessage={props.handleCloseMessage} />
        ) : (
          ""
        )}
