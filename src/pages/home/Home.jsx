  ...
  return (
    <div className="home_container">
      <div className="summary block">
        <h1>Welcome to Trillo - Your Travel Planning Companion</h1>
        <h4>Explore the World with Ease and Excitement</h4>
        <p>
          At Trillo, we understand that every journey is unique, and your travel
          planning experience should reflect that. Whether you're jet-setting
          across the globe or embarking on a local adventure, Trillo is here to
